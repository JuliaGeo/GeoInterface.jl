...
@test GI.extent(linestring) == Extent(X=(1, 3), Y=(2, 4))
...
@test GI.extent(linearring) == Extent(X=(1, 5), Y=(2, 6))
...
@test GI.extent(polygon) == Extent(X=(1, 5), Y=(2, 6))
...
@test GI.extent(multipoint) == Extent(X=(1, 9), Y=(2, 10))
...
@test GI.extent(polyhedralsurface) == Extent(X=(1, 5), Y=(2, 6))
